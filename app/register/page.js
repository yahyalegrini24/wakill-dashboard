...
export default function RegisterPage() {
  ...
  return (
    <div dir="rtl" className="min-h-screen flex bg-white font-sans">
      ...
      <div className="w-full lg:w-[45%] flex flex-col p-8 md:p-12 lg:p-16 justify-between">
        ...
        <div className="max-w-md w-full mx-auto">
          <div className="mb-10 text-right">
            <h1 className="text-3xl font-black text-slate-900 mb-3 tracking-tight">إنشاء حساب جديد</h1>
            <p className="text-slate-500 font-medium">ابدأ بتطوير تجارتك باستخدام قوة الذكاء الاصطناعي مجاناً.</p>
          </div>
          ...
          <p className="text-center text-sm text-slate-500 mt-8 font-medium">
            لديك حساب بالفعل؟{" "}
            <Link href="/login" className="text-[#25D366] font-black hover:underline underline-offset-4">
              تسجيل الدخول
            </Link>
          </p>
        </div>
      ...
      {/* RIGHT SIDE: MODERN SaaS VISUALS */}
          ...
          <div className="w-full bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 p-8 mb-16 transform -rotate-2 hover:rotate-0 transition-transform duration-700">
             ...
             <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className="grid grid-cols-3 gap-4">
                   <div className="h-24 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col items-center justify-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-[#25D366]/20"></div>
                      <div className="h-2 w-12 bg-slate-200 rounded-full"></div>
                   </div>
                   <div className="h-24 bg-[#25D366]/5 rounded-2xl border border-[#25D366]/20 flex flex-col items-center justify-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-[#25D366]"></div>
                      <div className="h-2 w-12 bg-[#25D366]/30 rounded-full"></div>
                   </div>
                   <div className="h-24 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col items-center justify-center gap-2">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-slate-50">
                    <div className="flex gap-2">
                       ...
                       <div className="h-2 w-20 bg-slate-100 rounded-full mt-2"></div>
                    </div>
                    <div className="px-4 py-2 bg-slate-900 rounded-lg h-8 w-24"></div>
                </div>
             </div>
          </div>

          {/* Slide Text */}
          <div className="text-center space-y-4 px-10 transition-all duration-500">
            ...
            <h2 className="text-4xl font-black text-slate-900 leading-tight transition-opacity">
