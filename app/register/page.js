    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-between p-10 bg-white">
        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          <h1 className="text-4xl font-bold text-[#1E293B] mb-2">Create account</h1>
          <p className="text-[#64748B] text-sm mb-8">
            Start managing your store with AI for free
          </p>
          ...
          <p className="text-center text-sm text-[#64748B] mt-6">
            ...
            <a href="/login" style={{color: "#1c98ed"}} className="font-semibold hover:underline">
              Login
            </a>
          </p>
